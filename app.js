...
const T = {
  en: {
    ...
    s1: 'Contracts analyzed', s2: 'Lost to rugpulls', s3: '7 networks supported',
  ...
  es: {
    ...
    s1: 'Contratos analizados', s2: 'Perdido en rugpulls', s3: '7 redes soportadas',
  ...
  ja: {
    ...
    s1: '分析済みコントラクト', s2: 'ラグプル被害', s3: '7つのネットワーク対応',
...
const CHECK_T = {
  es: {
    ...
    'Mint authority active — creator can print unlimited tokens': 'Mint authority activa — el creador puede imprimir tokens ilimitados',
    'Mint authority disabled — supply is fixed': 'Mint authority desactivada — el suministro es fijo',
    'Freeze authority active — your wallet can be frozen': 'Freeze authority activa — tu wallet puede ser congelada',
    'No freeze authority — your tokens cannot be frozen': 'Sin freeze authority — tus tokens no pueden ser congelados',
    'Metadata is mutable — name/image can be changed by creator': 'Metadata mutable — el nombre/imagen puede ser cambiado',
    'Metadata is immutable — cannot be changed': 'Metadata inmutable — no puede ser cambiada',
